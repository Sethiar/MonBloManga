"""
Script permettant de supprimer les données de la table article du blog.

Ce script se connecte à la base de données et supprime les informations des administrateurs enregistrés dans la table article.
...
conn.commit()
print('Toutes les données de la table article ont bien été supprimées.')
