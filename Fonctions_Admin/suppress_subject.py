"""
Script permettant de supprimer les données de la table subject du blog.

Ce script se connecte à la base de données et supprime les informations des sujets du forum enregistrés dans la table subject_forum.
...
cur.execute("DELETE FROM subject_forum")

# Validation de la transaction
conn.commit()
print('Toutes les données de la table subject_forum ont bien été supprimées.')
